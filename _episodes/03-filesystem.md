...
* `/cdt_storage/scw1738/bbt-data`,
  `/cdt_storage/scw1738/t2u-data` &ndash;
...
* `/cdt_storage/scw1738/bbt-shared`,
  `/cdt_storage/scw1738/t2u-shared` &ndash;
  shared directories for everyone attending the event to collaborate,
  one per charity.
